                        ...
                        <ul class="mainmenu d-flex justify-content-end">
                            ...
                            <li><a href="javascript:void(0);">blog <i class="fa fa-angle-down"></i></a>
								<ul>
									...
									<li><a href="blog-right.php">Blog Categories</a></li>
								</ul>
							</li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="metismenu">
                                ...
                                <li class="sidemenu-items"><a class="has-arrow" aria-expanded="false" href="blog.php">blog <i class="fa fa-angle-down"></i></a>
									<ul>
										<li><a href="blog.php">Blog page</a></li>
										<li><a href="blog-right.php">Blog Categories</a></li>
									</ul>
